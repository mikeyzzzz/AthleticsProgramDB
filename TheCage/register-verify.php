<?php
    ...
    if(isset($_POST['registerSubmit']))
    {
        ...
        $email = $_POST['email'];
        $classYear = $_POST['class_year_select'];
        $sportid = $_POST['sport_select'];
        ...
        $insertSql = "INSERT INTO Athlete (AthleteID, SportID, LiftgroupID, FirstName, LastName, PhoneNumber, Email, ClassYear, Username, Password) 
                      VALUES ('$athleteid', '$sportid', NULL, '$firstName', '$lastName', '$phoneNumber', '$email', '$classYear', '$username', '$password')";
